    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        try {
            if (idx_s != null) {
                ...
                String path = request.getRealPath("/") + "/img/member_profile/";
                ...
                imagePath = "/wishJam/img/member_profile/" + idx + ".jpg";
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
...
<body>
    ...
    <% } %>
    <form action = "ImgUpload.jsp?idx=<%=idx_s%>"name = "imgupload" method = "post" enctype="multipart/form-data">
        <div>
