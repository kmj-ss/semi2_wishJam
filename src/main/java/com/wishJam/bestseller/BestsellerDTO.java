...
public class BestsellerDTO {
	...
	public BestsellerDTO(int i, int j, int s_idx, String string, int s_discnt, int sg_main, int k) {
		this.s_idx = s_idx;
		this.s_title = s_title;
		this.sg_main = sg_main;
		this.m_nick = m_nick;
	...
	public BestsellerDTO(String m_nick,String s_title, int s_idx, int m_idx, int s_jjim, int sg_discnt,int s_discnt, int sg_main, int sg_price,  String s_img  ) {
